...
var searchedForTitle = document.querySelector(".searchedFor");
var searchButton = document.querySelector(".search img");

searchButton.addEventListener("click", function(event) {
    var inputContent = searchField.value;
    searchedForTitle.textContent = "Je hebt gezocht op: " + inputContent;
});
